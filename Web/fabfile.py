"""
Starter fabfile for deploying the Web project.
...
# CHANGEME
env.hosts = ['user@Web.example.com']
env.code_dir = '/srv/www/Web'
env.project_dir = '/srv/www/Web/Web'
env.static_root = '/srv/www/Web/static/'
env.virtualenv = '/srv/www/Web/.virtualenv'
env.code_repo = 'git@github.com:user/Web.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/Web/wsgi.py" % env.code_dir)
