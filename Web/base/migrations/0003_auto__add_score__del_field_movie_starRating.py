...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Score'
        db.create_table(u'base_score', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('movie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Movie'])),
            ('starRating', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mu', self.gf('django.db.models.fields.FloatField')(default=3.0)),
            ('sigma', self.gf('django.db.models.fields.FloatField')(default=1.0)),
        ))
        db.send_create_signal(u'base', ['Score'])

        # Deleting field 'Movie.starRating'
        db.delete_column(u'base_movie', 'starRating')


    def backwards(self, orm):
        # Deleting model 'Score'
        db.delete_table(u'base_score')

        # Adding field 'Movie.starRating'
        db.add_column(u'base_movie', 'starRating',
    ...
    models = {
        ...
        u'base.movie': {
            'Meta': {'ordering': "['name', '-scoreMu']", 'object_name': 'Movie'},
            ...
            'scoreSigma': ('django.db.models.fields.FloatField', [], {'default': '1.5'}),
            'year': ('django.db.models.fields.CharField', [], {'default': "'N/A'", 'max_length': '100'})
        },
        u'base.score': {
            'Meta': {'object_name': 'Score'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'movie': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Movie']"}),
            'mu': ('django.db.models.fields.FloatField', [], {'default': '3.0'}),
            'sigma': ('django.db.models.fields.FloatField', [], {'default': '1.0'}),
